...
📊 Data Sources (Synthetic + Kaggle)
            ↓
🧹 Data Processing Layer
            ↓
🤖 ML Prediction Model (Demand Forecasting)
            ↓
⚙️ Grid Dispatch Optimization Engine
            ↓
...
⚡ Smart grid dispatch simulation
